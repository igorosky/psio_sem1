...
public final class Menu {
    ...
    private static Department getDepartment() {
        try {
            return Department.getDepartment(ConsoleUI.choice(List.of("W1", "W2", "W3", "W4N", "W5", "W6", "W7", "W8", "W9", "W10", "W11", "W12", "W13", "W14")));
        } catch (Exception e) {
            // This state is impossible, input is validated so this try statement is infallible
        }
